 ...
 */
public class CustomLinearProgramming {
...
/*    public static void main(String[] args) throws Exception {
    ...
    public void runLinearProgrammingExample(String solverType, boolean printModel) {
        ...
        if (printModel) {
            model = solver.exportModelAsLpFormat();
        ...
        result += "Problem solved in " + solver.wallTime() + " milliseconds";

        System.out.println(result);

        result += "Optimal objective value = " + solver.objective().value();

        // The objective value of the solution.
        System.out.println(result);

        result += "x1 = " + x1.solutionValue();
        result += "x2 = " + x2.solutionValue();
        result += "x3 = " + x3.solutionValue();
